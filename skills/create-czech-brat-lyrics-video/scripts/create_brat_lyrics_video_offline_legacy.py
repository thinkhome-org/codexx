#!/usr/bin/env python3
"""Run the offline Brat generator with the original short-chunk grouping behavior."""

import importlib.util
import re
from pathlib import Path

BASE = Path(__file__).with_name("create_brat_lyrics_video_offline.py")
spec = importlib.util.spec_from_file_location("brat_offline_base", BASE)
